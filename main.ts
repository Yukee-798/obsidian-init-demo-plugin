...
interface InitRepoPluginSettings {
  mySetting: string;
}

const DEFAULT_SETTINGS: InitRepoPluginSettings = {
  mySetting: "default",
};

export default class InitRepoPlugin extends Plugin {
  settings: InitRepoPluginSettings;
